...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <button class="learn-more" onclick="checkFeeStatus()">Check Fee Status</button>
            <button class="learn-more" onclick="generateFeeBill()">Generate Fee Bill</button>
        </div>
    </div>
    ...
    <script>
        function checkFeeStatus() {
            ...
            window.location.href = "fee_status.php";
        }

        function generateFeeBill() {
            // Redirect to the generate fee bill page
            window.location.href = "generate_fee_bill.php";
        }
    </script>
</body>
</html>
