    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-image: url('pu.jpg'); /* Set background image */
...
<body>
    ...
    <div class="container">
        <div class="options">
            <div class="option-box" onclick="window.location.href='add_teacher.php'">
                <h2>Add Teacher</h2>
                <p>Add a new teacher to the database</p>
            </div>
            <div class="option-box" onclick="window.location.href='remove_teacher.php'">
                <h2>Remove Teacher</h2>
                <p>Remove an existing teacher from the database</p>
            </div>
            <div class="option-box" onclick="window.location.href='view_teachers.php'">
                <h2>View Teachers</h2>
                <p>View all teachers currently in the database</p>
            </div>
        </div>
    </div>
</body>
